...
public class TwitterProducer {
    ...
    String secret=rb.getString("secret");

    List<String> terms = Lists.newArrayList("tensorflow","kafka","rust","usa","politics","trump");
    ...
    public KafkaProducer<String, String> createKafkaProducer(){
        ...
        //High Throughput Producerat the xpense of latency and CPU
